...
export const PRICING_DATA: PricingRow[] = [
  { id: "p1", name: "Baby Spinach",   category: "vegetables", basePrice: 110, unit: "kg",    supply: 42,  demand: "High",   dynamicPrice: 143 },
  { id: "p2", name: "Carrot",         category: "vegetables", basePrice: 80,  unit: "kg",    supply: 120, demand: "Low",    dynamicPrice: 68  },
  { id: "p3", name: "King Coconut",   category: "fruits",     basePrice: 50,  unit: "pcs",   supply: 300, demand: "High",   dynamicPrice: 65  },
  { id: "p4", name: "Green Chilli",   category: "vegetables", basePrice: 250, unit: "kg",    supply: 18,  demand: "High",   dynamicPrice: 325 },
  { id: "p5", name: "Ginger",         category: "herbs",      basePrice: 140, unit: "kg",    supply: 85,  demand: "Medium", dynamicPrice: 140 },
  { id: "p6", name: "Gotukola",       category: "herbs",      basePrice: 60,  unit: "bunch", supply: 200, demand: "Low",    dynamicPrice: 48  },
  { id: "p7", name: "Tomato",         category: "vegetables", basePrice: 120, unit: "kg",    supply: 65,  demand: "Medium", dynamicPrice: 120 },
  { id: "p8", name: "Bitter Gourd",   category: "vegetables", basePrice: 50,  unit: "kg",    supply: 35,  demand: "Medium", dynamicPrice: 55  },
];
